...
import uk.ac.cam.cl.ajb327.exercises.Exercise1;
import uk.ac.cam.cl.ajb327.exercises.Exercise2;
...
public class Exercise2Tester {
	...
	public static void main(String[] args) throws IOException {
		...
		Map<Path, Sentiment> NBPredictions = implementation.naiveBayes(split.validationSet.keySet(), logProbs, classProbabilities);

		// With smoothing
		Map<String, Map<Sentiment, Double>> smoothedLogProbs = implementation.calculateSmoothedLogProbs(split.trainingSet);
		System.out.println("Log probabilities of smoothed classifier:");
		System.out.println(logProbs);
		System.out.println();

		Map<Path, Sentiment> smoothedNBPredictions = implementation.naiveBayes(split.validationSet.keySet(), smoothedLogProbs, classProbabilities);
